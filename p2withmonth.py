...
if leasing_option == 'y':
    ...
    # Calculate the remaining amount after the down payment
    remaining_amount = price - down_payment

    # Calculate the monthly payment based on the remaining amount
    monthly_payment = remaining_amount * MONTHLY_PERCENTAGE
...
if leasing_option == 'y':
    ...
    print(f"{'Monthly Tax:':20s}$ {(total_tax / months):,.2f}")
    print("-------------------------------")
